...
const REPO_ROOT = process.env.RAMTRI_SOLUTIONS_REPO_ROOT || path.resolve(__dirname, '..')
const DATA_DIR = process.env.RAMTRI_SOLUTIONS_DATA_DIR || path.join(REPO_ROOT, '.data')
