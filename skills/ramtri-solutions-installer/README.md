# Ramtri Solutions Installer Skill

Install and configure Ramtri Solutions on any Linux or macOS system.

## What This Skill Does

1. Detects the target OS and available runtimes (Docker or Node.js 20+)
2. Clones or updates the Ramtri Solutions repository
