# Ramtri Solutions Wiki

Last reviewed: 2026-03-05

Ramtri Solutions is an open-source dashboard for orchestrating AI agents: agents, tasks, costs, workflows, and gateway connectivity in one place.
...
- Agent: A worker connected to Ramtri Solutions that executes tasks and reports status/usage.
