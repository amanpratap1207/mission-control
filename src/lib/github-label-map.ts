/**
 * Bidirectional mapping between Ramtri Solutions statuses/priorities and GitHub labels.
...
const STATUS_LABEL_MAP: Record<TaskStatus, LabelDef> = {
  backlog:        { name: 'mc:backlog',        color: '94a3b8', description: 'Ramtri Solutions: backlog' },
  inbox:          { name: 'mc:inbox',          color: '6b7280', description: 'Ramtri Solutions: inbox' },
  assigned:       { name: 'mc:assigned',       color: '3b82f6', description: 'Ramtri Solutions: assigned' },
  in_progress:    { name: 'mc:in-progress',    color: 'eab308', description: 'Ramtri Solutions: in progress' },
  review:         { name: 'mc:review',         color: 'a855f7', description: 'Ramtri Solutions: review' },
  quality_review: { name: 'mc:quality-review', color: '6366f1', description: 'Ramtri Solutions: quality review' },
  done:           { name: 'mc:done',           color: '22c55e', description: 'Ramtri Solutions: done' },
  awaiting_owner: { name: 'mc:awaiting-owner', color: 'f97316', description: 'Ramtri Solutions: awaiting owner' },
  failed:         { name: 'mc:failed',          color: 'ef4444', description: 'Ramtri Solutions: failed' },
}
