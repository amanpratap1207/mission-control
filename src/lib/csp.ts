export function buildRamtriSolutionsCsp(input: { nonce: string; googleEnabled: boolean }): string {
...
export function buildNonceRequestHeaders(input: {
  ...
  const csp = buildRamtriSolutionsCsp({ nonce: input.nonce, googleEnabled: input.googleEnabled })
