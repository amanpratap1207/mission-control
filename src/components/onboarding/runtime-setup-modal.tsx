  ...
  return (
    <div className="p-6">
      ...
      <div className="p-4 rounded-lg border border-border/30 bg-secondary/20 text-sm text-muted-foreground space-y-2">
        <p>Ramtri Solutions reads OpenCode runtime status from the installed <code>opencode</code> CLI and scans session history from <code>~/.local/share/opencode/*.db</code>.</p>
        <p>Restart OpenCode or create a new OpenCode session if you want Ramtri Solutions to pick up fresh session activity immediately.</p>
      </div>
    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">Connect Hermes agent to Ramtri Solutions</p>
        </div>
        <button type="button" onClick={onClose} className="text-muted-foreground hover:text-foreground">
          <svg className="w-5 h-5" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><path d="M4 4l8 8M12 4l-8 8" /></svg>
        </button>
      ...
      {step === 'hook' && (
        <div className="space-y-4">
          <div className="p-4 rounded-lg border border-border/30 bg-secondary/20 space-y-3">
            <p className="text-sm font-medium">Install Ramtri Solutions Hook</p>
            <p className="text-xs text-muted-foreground">
              This installs a hook in <code className="text-[11px] bg-black/20 px-1 rounded">~/.hermes/hooks/ramtri-solutions/</code> that
              reports agent activity, session events, and status updates to Ramtri Solutions.
            </p>
            <div className="text-xs text-muted-foreground/60 space-y-1">
              ...
              <ul className="list-disc list-inside pl-2 space-y-0.5">
                ...
                <li>Enable task dispatching from Ramtri Solutions</li>
              </ul>
            </div>
          </div>
