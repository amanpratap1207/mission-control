...
import { useRamtriSolutions, type ConnectionStatus } from '@/store'
...
export function HeaderBar() {
  const { connection, sessions, unreadNotificationCount, activeTenant, activeProject, dashboardMode } = useRamtriSolutions()
...
function ModeBadge({
  ...
  const { dashboardMode } = useRamtriSolutions()
  const th = useTranslations('header')
