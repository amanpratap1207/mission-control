...
import { useRamtriSolutions, type CurrentUser } from '@/store'
...
function ContentRouter({ tab }: { tab: string }) {
  const tp = useTranslations('page')
  const { dashboardMode, interfaceMode, setInterfaceMode } = useRamtriSolutions()
