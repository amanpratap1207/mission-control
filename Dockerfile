...
ARG MC_VERSION=dev
LABEL org.opencontainers.image.source="https://github.com/builderz-labs/ramtri-solutions"
LABEL org.opencontainers.image.description="Ramtri Solutions - operations dashboard"
